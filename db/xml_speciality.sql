...
-- Дамп структуры для таблица lkzk.xml_speciality
CREATE TABLE IF NOT EXISTS `xml_speciality` (
  ...
  `UID_KindOfEducaion` varchar(2) COLLATE utf8mb4_unicode_ci NOT NULL,
