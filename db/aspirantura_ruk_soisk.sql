...
-- Дамп структуры для таблица lkzk.aspirantura_ruk_soisk
CREATE TABLE IF NOT EXISTS `aspirantura_ruk_soisk` (
  ...
  `prikaz` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  UNIQUE KEY `UID_Semester_fio_prikaz` (`UID_Semester`,`fio`,`prikaz`),
