...
// Разовый скрипт экспорта нагрузки discipline, ruk_kurs, ruk_practice после ошибок в ГУВ
...
$BaseUIDs = GetSQL("SELECT zavkaf_splits.base_uid
                    ...
                    USING (`base_uid`)
                    WHERE nagruzka_type IN('discipline', 'ruk_kurs', 'ruk_practice')
                    ", 'base_uid');
...
$doc->save("zavkaf_splits_fix_some.xml");
exit;
